...
namespace Room_System
{
    class Room
    {
        ...
        //get Rooms By MultipleFields
        public DataTable GetRoomsByMultipleFields(String searchTerm)
        {
            using (MySqlConnection connection = conn.GetConnection())
            {
                ...
                try
                {
                    ...
                    // Update the command to search across multiple fields and use a parameter for 'free'
                    using (MySqlCommand command = new MySqlCommand("SELECT * FROM rooms WHERE number LIKE @searchTerm OR type LIKE @searchTerm OR phone LIKE @searchTerm OR free LIKE @searchTerm", connection))
                    {
